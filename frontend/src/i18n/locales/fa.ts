...
export const fa: Dictionary = {
  ...
  discover: {
    ...
    moreActions: {
      ...
      backgroundSearches: 'جست‌وجوهای پس‌زمینه',
      exportTabResults: 'خروجی نتایج تب',
      exportCsv: 'خروجی CSV',
      exportJson: 'خروجی JSON',
      inspectTab: 'بازرسی تب',
      createAlertRule: 'ایجاد قانون هشدار',
      close: 'بستن',
      sessionMock: 'مدیریت نشست در محیط mock برای جریان رابط کاربری آماده است و اتصال نشست‌های ذخیره‌شده می‌تواند در ادامه انجام شود.',
      backgroundMock: 'در محیط mock هیچ جست‌وجوی پس‌زمینه‌ای در حال اجرا نیست.',
      alertMock: 'ایجاد قانون هشدار در این مرحله به‌صورت یک جایگاه رابط کاربری در جریان mock Discover نمایش داده می‌شود.',
    },
    toolbar: {
      share: 'اشتراک‌گذاری',
      queryInEsql: 'Query در ES|QL',
      classicKql: 'Classic / KQL',
      moreActions: 'اقدامات بیشتر',
      save: 'ذخیره',
      newTab: 'تب جدید Discover',
    },
    inspector: {
      title: 'بازرس',
      view: 'نما',
      requests: 'درخواست‌ها',
      profiles: 'پروفایل‌ها',
      requestCount: (count) => `${count} درخواست ارسال شد`,
      statistics: 'آمار',
      clusters: 'کلاسترها و شاردها',
      request: 'درخواست',
      response: 'پاسخ',
      documents: 'اسناد',
      hits: 'تعداد نتایج',
      hitsTotal: 'کل نتایج',
      dataViewId: 'شناسه نمای داده',
      requestTimestamp: 'زمان درخواست',
      copy: 'کپی در کلیپ‌بورد',
      copied: 'کپی شد',
      openConsole: 'باز کردن در Console',
      successful: 'موفق',
      of: 'از',
      primaryCluster: 'کلاستر اصلی',
      shardsQueried: (count) => `${count} شارد بررسی شد`,
      total: 'کل',
      skipped: 'ردشده',
      failed: 'ناموفق',
      profilesUnavailable: 'پروفایل‌ها',
      profilesUnavailableDescription: 'پروفایل درخواست پس از اتصال Query واقعی و API پروفایل در دسترس خواهد بود.',
      clustersDescription: 'کلاسترها و شاردهای درگیر در این درخواست.',
      dataView: 'نمای داده',
      queryTime: 'زمان Query',
      apiRoute: 'مسیر API',
      timeRange: 'بازه زمانی',
      documentsRequest: (dataView) => `این درخواست برای دریافت اسناد، ${dataView} را Query می‌کند.`,
      fieldStatisticsRequest: 'این درخواست آمار سطح فیلد را برای نمای فعلی Discover محاسبه می‌کند.',
    },
  },
  visualize: {
    title: 'تجسم‌سازی',
